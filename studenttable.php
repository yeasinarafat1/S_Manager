<!-- Student Table
This file contains the HTML and PHP code for the student table
in the index.php page. The table displays all the students in the
database, along with their roll, name, semester, shift, and phone
number. The table is also searchable by roll, name, and semester.
-->
    ...
    <table id="myTable" class="table">
        <thead>
            <tr>
                ...
                <!-- If the user is logged in, display the edit and delete buttons -->
        ...
        <tbody>
            ...
            if (!$result) {
                ...
                if (mysqli_num_rows($result) == 0) {
                    $colspan = isset($_COOKIE['remember_username']) ? 7 : 5;
                    // If no students found, display this message
                    echo "<tr><td colspan='$colspan'><p class='text-center fw-medium mt-4 fs-3'>No Student Found</p></td></tr>";
                } else {
